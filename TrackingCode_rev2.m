%%% Script that analyzes the thermal vibration of chromatin spots and
%%% extracts diffusivity, displacement histogram, etc
%%% Uses image files from Camera Control

%%% Arash Tajik, August 2014, Rev 1
%%% Fazlur Rashid, June 2024

%%%Rev2 Arash Tajik August 2014; added compensation for drift Check line 54
